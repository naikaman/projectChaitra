      ...
      (function (e) {
        ...
        window.addEventListener("hashchange", function () {
          ...
          e("a").on("click", function (n) {
            var r,
              o = e(this).attr("href");
            (r = (o = void 0 === o ? "" : o).startsWith("#")) ||
              (r = (o = o.replace(localize.page_permalink, "")).startsWith(
                "#"
              )),
              r &&
                ((t = !1),
        ...
        function (e) {
          ...
          (r && "" !== r && "NaN" !== r) || (r = 0),
            ...
            t.hasClass("nm-qty-plus")
              ? o && (o == r || r > o)
                ? n.val(o)
                : n.val(r + parseFloat(a))
              : i && (i == r || r < i)
              ? n.val(i)
              : r > 0 && n.val(r - parseFloat(a));
        }
      ),
      (function (e) {
