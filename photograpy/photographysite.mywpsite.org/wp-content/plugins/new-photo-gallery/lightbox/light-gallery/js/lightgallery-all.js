  ...
  (function () {
    ...
    Zoom.prototype.zoomSwipe = function () {
      ...
      _this.core.$slide.on("touchstart.lg", function (e) {
        if (_this.core.$outer.hasClass("lg-zoomed")) {
          ...
          allowY =
            $image.prop("offsetHeight") * $image.attr("data-scale") >
            _this.core.$outer.find(".lg").height();
          allowX =
            $image.prop("offsetWidth") * $image.attr("data-scale") >
    ...
    Zoom.prototype.touchendZoom = function (
      ...
      var distanceY =
        -Math.abs(_$el.attr("data-y")) + (endCoords.y - startCoords.y);
      var minY =
        (_this.core.$outer.find(".lg").height() - $image.prop("offsetHeight")) /
        2;
      var maxY = Math.abs(
        $image.prop("offsetHeight") * Math.abs($image.attr("data-scale")) -
          _this.core.$outer.find(".lg").height() +
          minY
      );
      var minX =
        (_this.core.$outer.find(".lg").width() - $image.prop("offsetWidth")) /
        2;
      var maxX = Math.abs(
        $image.prop("offsetWidth") * Math.abs($image.attr("data-scale")) -
          _this.core.$outer.find(".lg").width() +
          minX
      );
